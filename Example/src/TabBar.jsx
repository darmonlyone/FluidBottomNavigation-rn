// Made by 10clouds/FluidBottomNavigation-rn
// implement by Darm
...
class TabBar extends Component {
  constructor(props) {
    ...
    this.startAnimation(this.props.initTab);
  }
  ...
  state = {
    lastSelectedIndex: this.props.initTab,
  };
        ...
        >
          <AnimatedViewOverflow style={[styles.item, animatedItemStyle]}>
            <Image
              ...
              source={require("../../assets/tabbar/mask.png")}
            />
            <Animated.View
              style={[
                styles.bubble,
...
TabBar.propTypes = {
  initTab: PropTypes.number.isRequired,
